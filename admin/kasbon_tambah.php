<?php
	...
	if(isset($_POST['simpan'])) {
		...
		$sql = "INSERT INTO kasbon(karyawan_id,kasbon_tgl,kasbon_jml)VALUES('$kry','$tgl','$jml')";
		...
		//	echo("Error description: " . mysqli_error($conn));
			...
			echo "<script type='text/javascript'> document.location = 'kasbon_tambah.php'; </script>";
		}
	}
?>
<!-- top of file -->
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="number" name="jml" min="0" class="form-control" placeholder="Jumlah Kasbon" required>
										</div>
									</div>
								</div>
