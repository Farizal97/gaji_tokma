...
while ($dataabsen = mysqli_fetch_array($ressabsen)) {
	$idkry = $dataabsen['karyawan_id'];
	...
	// deskripsi halaman
	$pagedesc = "Slip Gaji Karyawan Periode Tanggal " . IndonesiaTgl($mulai) . " s/d " . IndonesiaTgl($selesai);
